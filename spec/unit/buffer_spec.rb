...
RSpec.describe HarfBuzz::Buffer do
  ...
  describe "#random_state / #random_state=" do
    before do
      skip "requires HarfBuzz >= 7.2.0" unless HarfBuzz::C.respond_to?(:hb_buffer_get_random_state)
    end
  ...
  describe "#each_glyph" do
    ...
    it "yields glyph data matching glyph_infos and glyph_positions" do
      ...
      yielded = []
      result = buffer.each_glyph { |*glyph| yielded << glyph }
